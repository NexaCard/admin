...
const openEditModal = (conn: AdminSiteConnection) => {
  ...
  Object.assign(form, {
    ...
    protocol: conn.protocol || 'nexacard-openapi',
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <Select v-model="form.protocol">
                ...
                <SelectContent>
                  <SelectItem value="nexacard-openapi">NexaCard OpenAPI</SelectItem>
                  <SelectItem value="dujiao-next">NexaCard OpenAPI (legacy)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
